...
my $nr=0;
$nr=`/usr/local/common/bin/snmpwalk -v 2c -c $opt_C $host SNMPv2-SMI::enterprises.789.1.5.4.1.10 | /bin/grep $opt_v| /bin/grep -v snapshot | /bin/awk -F' ' '{print \$1}' | /bin/awk -F. '{print \$NF}' `;
$dfBT=`/usr/local/common/bin/snmpget -v 2c -c $opt_C $host SNMPv2-SMI::enterprises.789.1.5.4.1.3.$nr`;
$dfBU=`/usr/local/common/bin/snmpget -v 2c -c $opt_C $host SNMPv2-SMI::enterprises.789.1.5.4.1.4.$nr`;
...
$dfMF=`/usr/local/common/bin/snmpget -v 2c -c $opt_C $host SNMPv2-SMI::enterprises.789.1.5.4.1.11.$nr`;
$dfUF=`/usr/local/common/bin/snmpget -v 2c -c $opt_C $host SNMPv2-SMI::enterprises.789.1.5.4.1.12.$nr`;
