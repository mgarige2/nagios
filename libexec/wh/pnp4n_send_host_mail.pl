...
my $domain             = "\@reachlocal.com"; # only for -g group
my @listaddress        = ();
...
sub create_test_data {
  ...
  if (! defined($o_hoststate)){        $o_hoststate        = "WARNING";}
...
sub create_message_html {
  ...
  if ($o_format eq "multi" || $o_format eq "graph") {
    ...
    $html_msg .= "<td><img class=\"logo\" src=\"cid:$logo_id\"></td>"
              .  "<td><span><B>$language{$land}{'L'}</B></span></td></tr><tr>\n";
  }# else {
  ...
  $html_msg = $html_msg
            ...
            . "<tr><th class=odd>$language{$land}{'C'}:</th><td bgcolor=#eaeaea>$o_hoststate</td></tr>\n"
            . "<tr><th class=even>$language{$land}{'D'}:</th><td bgcolor=#c9c9c9 class=even>\n";

  if (defined($o_addurl)) {
    $html_msg .= "<a href=\"$nagios_cgiurl/extinfo.cgi?type=1&host=" . urlencode($o_hostname) ."\">$o_hostname</a>";
  } else { $html_msg .= $o_hostname; }
  
  $html_msg = $html_msg . "</td></tr>\n"
            . "<tr><th class=odd>$language{$land}{'E'}:</th><td bgcolor=#eaeaea>$o_hostalias</td></tr>\n"
            . "<tr><th class=even>$language{$land}{'F'}:</th><td bgcolor=#c9c9c9 class=even>$o_hostaddress</td></tr>\n"
            . "<tr><th class=odd>$language{$land}{'G'}:</th><td bgcolor=#eaeaea>\n";
  ...
  $html_msg = $html_msg . "</td></tr>\n"
             . "<tr><th class=even>$language{$land}{'H'}:</th><td bgcolor=#c9c9c9 class=even>$o_datetime</td></tr>\n"
             . "<tr><th class=odd>$language{$land}{'I'}:</th><td bgcolor=#eaeaea>\n";
...
sub import_pnp_graph {
  ...
  #$img_get = "https://monitoring.wh.reachlocal.com/pnp4nagios/image?host=ad.sandbox.dev&srv=CPU_Load&start=1352759265&end=1352845665";
...
sub set_subject {
  ...
  my %lang =  ('en' => "** $o_notificationtype Host Alert: $o_hostname is $o_hoststate **",
