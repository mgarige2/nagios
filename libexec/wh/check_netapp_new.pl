...
#my $snmpCifsOps = '.1.3.6.1.4.1.789.1.5.8';
my $snmpCifsOps = '.1.3.6.1.4.1.789.1.7.3.1.1.1';
#my $snmpNFSOps = '1.3.6.1.4.1.789.1.2.2.1';
my $snmpNFSOps = '.1.3.6.1.4.1.789.1.2.2.1';
#my $snmpFCOps = '.1.3.6.1.4.1.789.1.17.4';
my $snmpFCOps = '.1.3.6.1.4.1.789.1.17.13';
my $snmpNetInKb = '.1.3.6.1.4.1.789.1.2.2.2';
my $snmpNetOutKb = '.1.3.6.1.4.1.789.1.2.2.3';
...
} elsif ( $variable eq 'CIFSOPS' ) {
	$state = 'OK';
	my $cifs=$snmpresponse{$snmpCifsOps}{0};
	$answer = sprintf("CIFS ops: %d ",$cifs);
	$perfdata = sprintf("CIFS ops=%d",$snmpresponse{$snmpCifsOps}{0});
} elsif ( $variable eq 'NFSOPS' ) {
	$state = 'OK';
	my $cifs=$snmpresponse{$snmpNFSOps}{0};
	$answer = sprintf("CIFS ops: %d ",$cifs);
	$perfdata = sprintf("CIFS ops=%d",$snmpresponse{$snmpNFSOps}{0});
} elsif ( $variable eq 'FCOPS' ) {
	$state = 'OK';
	my $cifs=$snmpresponse{$snmpFCOps}{0};
	$answer = sprintf("CIFS ops: %d ",$cifs);
	$perfdata = sprintf("CIFS ops=%d",$snmpresponse{$snmpFCOps}{0});
} elsif ( $variable eq 'NETIN' ) {
	$state = 'OK';
	my $cifs=$snmpresponse{$snmpNetInKb}{0};
	$answer = sprintf("Net In Kb: %d ",$cifs);
	$perfdata = sprintf("Net In Kb=%d",$snmpresponse{$snmpNetInKb}{0});
} elsif ( $variable eq 'NETOUT' ) {
	$state = 'OK';
	my $cifs=$snmpresponse{$snmpNetOutKb}{0};
	$answer = sprintf("Net Out Kb: %d ",$cifs);
	$perfdata = sprintf("Net Out Kb=%d",$snmpresponse{$snmpNetOutKb}{0});
